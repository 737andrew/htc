     ...
     <li class="active">Юмор</li>
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <h1><a href="http://htc/humor/temp2humor.php">A Blog Home Template for Bootstrap 3</a>
                </h1>
                <hr>
                ...
                <ul class="pager">
                    <li class="previous"><a href="http://htc/humor/humor.php">&larr; Назад</a>
                    </li>
                    <li class="next"><a href="http://htc/humor/humor1.php">Дальше &rarr;</a>
                    </li>
                </ul>
