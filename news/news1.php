...
<body>
	...
	<div class="row">
            ...
            <div class="col-lg-12">
                <h1 class="page-header"><h1>Новости стройки
                    <small>все что связанно с ремонтом и не только</small>
                </h1>
                <ol class="breadcrumb">
     <li><?php echo $crumb ?>
     </li>
     <li class="active">Новости</li>
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <ul class="pager">
                    <li class="previous"><a href="http://htc/news/news.php">&larr; Назад</a>
                    </li>
                    <li class="next"><a href="http://htc/news/news1.php">Дальше &rarr;</a>
                    </li>
                </ul>
